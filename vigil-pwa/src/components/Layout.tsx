...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-50">
      ...
      <div
        className="flex border-b border-gray-900/40 overflow-x-auto"
      ...
      >
        {ALL_TABS.map((tab) => (
          <Link
            key={tab.to}
            to={tab.to}
            className={`flex-none px-3 py-2.5 text-sm font-medium border-b-2 whitespace-nowrap transition-colors ${
              isActive(tab.to)
