...
- [x] **AUTH-02**: User can register with email and password (API endpoint)
...
- [x] **AUTH-05**: All API routes scope data queries to the authenticated user's userId
