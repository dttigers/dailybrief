...
- [x] 86-03-PLAN.md — PWA Settings UI (two ScheduleCards + timezone picker)
- [x] 86-04-PLAN.md — Mac CLI pull-only mode + exit code 2 staleness sentinel
- [x] 86-05-PLAN.md — Menubar staleness UI + Doctor Check 6 covering 3 endpoints
