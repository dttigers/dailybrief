...
<details>
<summary>✅ v2.4 Capture Without Friction (Phases 58-62) — SHIPPED 2026-04-10</summary>

- [x] Phase 58: Persistent Code Signing (2/2 plans) — completed 2026-04-09
- [x] Phase 59: Smart Photo Upload Backend (2/2 plans) — completed 2026-04-09
- [x] Phase 60: Smart Photo Upload Dashboard UX (2/2 plans) — completed 2026-04-09
- [x] Phase 61: Folder Watch Feeder (2/2 plans) — completed 2026-04-10
- [x] Phase 62: Folder Watch Settings UI (1/1 plan) — completed 2026-04-10

**Archive:** [.planning/milestones/v2.4-ROADMAP.md](milestones/v2.4-ROADMAP.md) · [.planning/milestones/v2.4-REQUIREMENTS.md](milestones/v2.4-REQUIREMENTS.md)

</details>

<details>
<summary>✅ v2.5 Dashboard Everywhere (Phases 63-72) — SHIPPED 2026-04-12</summary>

- [x] Phase 63: PWA Foundation (2/2 plans) — completed 2026-04-12
- [x] Phase 64: Thoughts Dashboard (2/2 plans) — completed 2026-04-12
- [x] Phase 65: Work Order Status API (2/2 plans) — completed 2026-04-12
- [x] Phase 66: Work Orders Dashboard (2/2 plans) — completed 2026-04-12
- [x] Phase 67: Projects UI (1/1 plan) — completed 2026-04-12
- [x] Phase 68: Bulk Actions & Filters (2/2 plans) — completed 2026-04-12
- [x] Phase 69: AI Chat (1/1 plan) — completed 2026-04-12
- [x] Phase 70: Insights & Therapy (2/2 plans) — completed 2026-04-12
- [x] Phase 71: Brief History & Photo Upload (2/2 plans) — completed 2026-04-12
- [x] Phase 72: README (1/1 plan) — completed 2026-04-12

**Archive:** [.planning/milestones/v2.5-ROADMAP.md](milestones/v2.5-ROADMAP.md) · [.planning/milestones/v2.5-REQUIREMENTS.md](milestones/v2.5-REQUIREMENTS.md)
...
<details>
<summary>✅ v3.3 Stability & Chat Context (Phases 96-98) — SHIPPED 2026-04-17</summary>

**Milestone Goal:** Fix broken daily workflows (chat, print, task visibility) and add contextual chat from individual thoughts.

- [x] **Phase 96: PWA Fixes** (2/2 plans) — completed 2026-04-16
- [x] **Phase 97: Mac CLI Print Reliability** (2/2 plans) — completed 2026-04-17
- [x] **Phase 98: Thought-Contextual Chat** (1/1 plan) — completed 2026-04-17
...
<details>
<summary>✅ v3.4 Multi-User Foundation & PWA Polish (Phases 99-102) — SHIPPED 2026-04-18</summary>
...
- [x] **Phase 99: Brief History Fix** (3/3 plans) — completed 2026-04-17
- [x] **Phase 100: Edit-Refresh Pause** (1/1 plan) — completed 2026-04-18
- [x] **Phase 101: Context Menu** (5/5 plans) — completed 2026-04-18
- [x] **Phase 102: Multi-User Foundation** (6/6 plans) — completed 2026-04-18

**Audit:** [v3.4-MILESTONE-AUDIT.md](milestones/v3.4-MILESTONE-AUDIT.md) · **Archive:** [v3.4-ROADMAP.md](milestones/v3.4-ROADMAP.md) · [v3.4-REQUIREMENTS.md](milestones/v3.4-REQUIREMENTS.md)

</details>

<details>
<summary>✅ v3.6 Multi-User Completion, Auth UX & Safari Parity (Phases 108-114) — SHIPPED 2026-04-26</summary>
...
- [x] **Phase 108: work_order_statuses userId Scoping + Isolation Test** (3/3 plans) — completed 2026-04-23
- [x] **Phase 109: Per-User Scheduler Fan-Out** (3/3 plans) — completed 2026-04-23
- [x] **Phase 110: Change Password + password_changed_at Gate** (3/3 plans) — completed 2026-04-24
- [x] **Phase 111: Transactional Email Infrastructure (Resend + DNS)** (3/3 plans) — completed 2026-04-24
- [x] **Phase 112: Forgot-Password Email Flow** (5/5 plans) — completed 2026-04-25
- [x] **Phase 113: Verify Email on Signup** (5/5 plans) — completed 2026-04-26
- [x] **Phase 114: Safari Extension Quick-Capture Parity** (5/5 plans) — completed 2026-04-26

**Notable post-ship:** Late-breaking Phase 102 Google OAuth init regression hotfixed in same session (commits `1df403d`, `58d8101`); task category exempted from default 7-day window (commit `b4e47a2`); 4 follow-up items captured (SEED-003 DMARC ramp, SEED-004 verify-email error UX, todos for gmail-workorders + ThoughtRow whitespace).
...
<details>
<summary>✅ v3.7 Source Pickers, Verify-Email UX & Closeout Cleanup (Phases 115-119 + insert 116.1) — SHIPPED 2026-05-06</summary>

Full milestone scope archived to [milestones/v3.7-ROADMAP.md](milestones/v3.7-ROADMAP.md) and shipped narrative in [MILESTONES.md](MILESTONES.md). Phase directories archived to [milestones/v3.7-phases/](milestones/v3.7-phases/).

- [x] Phase 115: Calendar source picker (+ ThoughtRow whitespace polish) (4/4 plans) — completed 2026-04-28
- [x] Phase 116: Sports source picker (5/5 plans) — completed 2026-04-29
- [x] Phase 116.1: Sports route + PWA error-class differentiation (INSERTED) (4/4 plans) — completed 2026-04-30
- [x] Phase 117: Auth-email rate-limit UX hardening (5/5 plans) — completed 2026-04-30
- [x] Phase 118: Production test-user cleanup (2/2 plans) — completed 2026-05-01
- [x] Phase 119: DMARC quarantine ramp (2/2 plans) — completed 2026-05-06 via operator amendment (DMARC gate returned DEFERRED on 0/3 conditions; `p=none` accepted as steady-state DMARC posture; routine `trig_01RZLcj1jpxvDQAwnFmUG9d9` preserved with three documented re-activation conditions)

**Notable:** Phase 119's terminal state was redirected from "ramp executes" to "ramp formally deferred" after the auto-eval routine surfaced that vigilhub.io's pre-growth email volume is below the threshold at which DMARC aggregate reports flow daily. The amendment pattern (operator-decision record with structured re-activation conditions) is reusable for future plans whose execution gates become structurally unsatisfiable.

**Archive:** [v3.7-ROADMAP.md](milestones/v3.7-ROADMAP.md) · [v3.7-REQUIREMENTS.md](milestones/v3.7-REQUIREMENTS.md)
...
<details>
<summary>✅ v3.8 Claude Code Companion (Phases 120-126) — SHIPPED 2026-05-11</summary>

Full milestone scope archived to [milestones/v3.8-ROADMAP.md](milestones/v3.8-ROADMAP.md) and shipped narrative in [MILESTONES.md](MILESTONES.md). Requirements (28/28 complete) archived to [milestones/v3.8-REQUIREMENTS.md](milestones/v3.8-REQUIREMENTS.md).

- [x] Phase 120: Day-1 JSONL schema verification + detection-strategy lock (3/3 plans) — completed 2026-05-07; verdict `spec-correct-and-proceed`, no fallback path needed
- [x] Phase 121: Agent-events API foundation + cross-user isolation lock (5/5 plans) — completed 2026-05-08; W-01/W-02-style isolation pinned at structural-test level
- [x] Phase 122: vigil-watch core — watcher + parser + emitter + config (10/10 plans) — completed 2026-05-09; Swift 6 strict-concurrency-safe FSEventStream daemon
- [x] Phase 123: vigil-watch shell — launchd + CLI surface + 24h soak (5/5 plans) — completed 2026-05-11; 24h SOAK PASSED (max RSS 7220 KB / unique PIDs 1 / uptime span 23h 55m)
- [x] Phase 124: G2 Companion HUD + WebSocket fan-out + launch-source/home-overflow polish (9/9 plans) — completed 2026-05-10; per-userId SSE + 3-line glanceable HUD + context-sensitive DOUBLE_CLICK
- [x] Phase 125: Quiet mode + remaining polish riders + plugin v0.3.0 ship + portfolio demo (11/11 plans) — completed 2026-05-11; vigil.ehpk v0.3.0 resubmitted to Even Hub
- [x] Phase 126: Wide-release auth hardening (11/11 plans, MID-MILESTONE INSERT) — completed 2026-05-11; Turnstile + rate-limit + email-verify gate + Sentry sink + legal pages + spend cap + `*` sentinel kill-switch; SECURITY 46/46 threats closed
...
- [x] 130-02-PLAN.md — Server: migration 0023 voice_captures dedup + voice-transcribe.ts route + transcribe.ts (OpenAI lazy-init) + withOpenAIBudgetTracking + three locked-enum error classes + app.onError translation

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 130-03-PLAN.md — SSE fan-out: thought-created channel on agent-events-bus + agent-stream.ts multiplex + PWA useAgentStream subscriber + 3 api-error-codes entries + D8 round-trip integration test
- [x] 130-04-PLAN.md — G2 plugin: wav-encoder.ts + production voice.ts screen + safeAudioControl Promise<boolean> hardening + main.ts cross-screen state + navigation/constants wiring
...
| 38. API Key Authentication | v2.1 | 1/1 | Complete | 2026-04-05 |
| 39. Railway Deployment | v2.1 | 2/2 | Complete | 2026-04-05 |
| 40. Data Migration | v2.1 | 1/1 | Complete | 2026-04-05 |
| 41. G2 Plugin Production URL | v2.1 | 1/1 | Complete | 2026-04-05 |
...
| 120. Day-1 JSONL schema verification + detection-strategy lock | v3.8 | 3/3 | Complete | 2026-05-07 |
...
| 123. vigil-watch shell — launchd + CLI surface + 24h soak | v3.8 | 5/5 | Complete | 2026-05-11 |
...
- [ ] 999.1-01-PLAN.md — Wave 1. Scaffold dry-run branch + verify-ubiquity.sh probe runner (final-success line `verify-ubiquity: all checks passed` locked) + gitignore for provisioning profile
- [ ] 999.1-02-PLAN.md — Wave 2 (depends on 01). Operator portal work (App ID iCloud, container, Developer ID profile) + rollback rehearsal; includes container-fallback handoff procedure if Open Question 4 fires
...
<!-- Phase 126 inline details removed during v3.8 milestone close 2026-05-11 — phase was a mid-milestone insert; full content archived to milestones/v3.8-ROADMAP.md -->
