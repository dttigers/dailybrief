...
---
*Last updated: 2026-04-28 — Phase 115 complete (CAL-01 calendar source picker + POLISH-01 ThoughtRow whitespace), live UAT 5/5 PASS, CR-01 reload-preservation gap closed in 115-04. v3.7 milestone now 1/5 phases complete; remaining: 116 (sports source picker), 117 (auth-email rate-limit UX), 118 (prod test-user cleanup), 119 (DMARC quarantine ramp). Backlog 999.2 captured: CaptureBar `<input>` strips paste-side newlines — out of scope for POLISH-01 D-16, surfaced during Phase 115 UAT. Token rotation copy (rotated vs expired) explicitly deferred — captured as SEED-004 follow-up.*
